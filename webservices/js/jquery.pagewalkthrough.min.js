...
;(function ($, window, document, undefined) {
    ...
    */
    var _globalWalkthrough = {},
         ...
         $jpwTooltip = $('<div id="jpwTooltip" class="outerroundedbox"></div>');
    ...
    */
     ...
     */
     function showCloseButton(){
        if(!$('jpwClose').length){
            $('body').append('<div id="jpwClose"><a href="javascript:;" title="Click here to close"><span></span><br>Close tutorial</a></div>');
        }
     }

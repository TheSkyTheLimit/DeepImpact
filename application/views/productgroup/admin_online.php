...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array('name'=>'catID', 'value'=>'Categories::model()->findByPk($data->catID)->catName', 'filter'=>CHtml::dropDownList('ProductGroup[catID]','catID',CHtml::listData(Categories::model()->findAll(),'catID','catName'),array( 'empty' => '- N/A -','options'=>array('$data->catID'=>'selected'))),'htmlOptions'=>array('style'=>'width:180px'),) ,

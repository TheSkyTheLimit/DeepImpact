...
class PushNotificationController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['PushNotification']))
		{
			...
			if($model->save())
				$sql = "insert into push_histories (pushID,prodID,devIDs,pushMsg) Select '".$model->pushID."',0,deviceID,'".$model->pushURL."' from customers where  deviceType =2 and isDeleted = 0";
				Yii::app()->db->createCommand($sql )->execute();
			//	echo $sql ;
				$this->redirect(array('view','id'=>$model->pushID));
		}
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='push-notification-form')
		{
